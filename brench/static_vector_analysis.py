...
with open('results-static-vector.csv', newline='') as csvfile:
    ...
    assert len(op) == len(naive) == len(benchmark_names)
    ...
    ax.set_title(
        'Number of Vectors Created Statically in 2 Different Vectorization Strategies')
